...
subplot(2,2,1); hist(C_coeff_final{k1,1}(:,n1)); title(sprintf('C(%d),%s', n1, strjoin(digitnames(k1))));
subplot(2,2,2); hist(C_coeff_final{k1,1}(:,n2)); title(sprintf('C(%d),%s', n2, strjoin(digitnames(k1))));
subplot(2,2,3); hist(C_coeff_final{k2,1}(:,n1)); title(sprintf('C(%d),%s', n1, strjoin(digitnames(k2))));
subplot(2,2,4); hist(C_coeff_final{k2,1}(:,n2)); title(sprintf('C(%d),%s', n2, strjoin(digitnames(k2))));
...
%%Step 10
%importing the Hmm Toolbox
%addpath(genpath('C:/Program Files/MATLAB/R2016a/HMMall'))
%testHMM

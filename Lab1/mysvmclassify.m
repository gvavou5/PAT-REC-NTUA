function [outclass,distances] = mysvmclassify(svmStruct,sample, varargin)

%%modified smvclassify so as to take scores
%suggested differatiations taken from : http://stackoverflow.com/questions/28378722/how-to-find-the-score-of-a-svm-classifier-in-matlab
...
if ~isempty(sample)
    ...
    try
        [outclass,distances] = svmdecision(sample,svmStruct);
    catch ME
